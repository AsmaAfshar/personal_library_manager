...
def main():
    ...
    lottie_book = load_lottieurl("https://assets10.lottiefiles.com/packages/lf20_FYx0Ph.json") 
    if lottie_book:
        with st.sidebar:
    ...
    if st.session_state.current_view == "add":
        ...
        with st.form(key='add_book_form'):
            ...
            with col2:
                genre = st.selectbox("Genre", [
                    ...
                    "Fantasy", "Romance", "Science", "Technology", "Poetry", 
                    "Religion", "Philosophy", "Art", "Self-help", "Other"
                ])     
        ...
        if st.session_state.book_added:  # Fixed: Changed from book_read to book_added
    ...
    # View Library
        ...
        st.markdown("<h2 class='sub-header'>Your Library</h2>", unsafe_allow_html=True)  # Fixed: Added closing >
